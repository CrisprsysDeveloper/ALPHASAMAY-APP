...
import 'package:crysprsys/bindings/dashboard_report_binding.dart';
...
import 'package:crysprsys/screens/dashboard/dashboard_report_screen.dart';
...
class AppPages {
  ...
  static final routes = [
    ...
    GetPage(
      name: Routes.dashboardReportScreen,
      page: () => DashboardReportScreen(),
