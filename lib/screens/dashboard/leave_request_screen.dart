      ...
      child: Scaffold(
        ...
        body: SingleChildScrollView(
          ...
          child: Form(
            child: Column(
              children: [
                buildEditableField("Leave Id", "1000000128",1),

                buildDropdownField("Employee No", personalNumber,
                    ['1007-Harish Narakuduru', '1008-Rajesh Kumar'], (val) {
                      setState(() => personalNumber = val);
                    }),

                buildReadOnlyField("Leave Start Date", "05/02/2025"),
                buildReadOnlyField("Leave End Date", "05/02/2025"),
                buildDropdownField("Leave Type", requestType,
                    ['Annual Leave', 'Personal Leave', 'Sick Leave', 'Official'], (val) {
                      setState(() => requestType = val);
                    }),
                buildReadOnlyField("Leave Status", "Submitted"),
                buildReadOnlyField("Pending with",
                    "vikram - Vikram - vilas.vikram@gmail.com"),
                buildEditableField("Leave Reason", "Leave for personal",3),
