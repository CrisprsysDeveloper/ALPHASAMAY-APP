...
import '../../model/dashboard/justification_model.dart';

class TimeJustificationController extends GetxController {
  final TokenRepository authRepository;

  TimeJustificationController({required this.authRepository});
